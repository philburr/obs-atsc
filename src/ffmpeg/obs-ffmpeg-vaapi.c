...
static void vaapi_defaults(obs_data_t *settings)
{
	...
	obs_data_set_default_int(settings, "vaapi_codec", AV_CODEC_ID_MPEG2VIDEO);
	obs_data_set_default_int(settings, "profile",
			FF_PROFILE_MPEG2_MAIN);
	obs_data_set_default_int(settings, "level", 4);
	obs_data_set_default_int(settings, "bitrate", 0);
	obs_data_set_default_int(settings, "keyint_sec", 0);
	obs_data_set_default_int(settings, "bf", 0);
	obs_data_set_default_int(settings, "qp", 0);
...
static obs_properties_t *vaapi_properties(void *unused)
{
	...
	obs_property_list_add_int(list, "MPEG2 (default)", AV_CODEC_ID_MPEG2VIDEO);
